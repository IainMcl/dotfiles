...
vim.api.nvim_set_keymap("n", "<leader>z", "z=1<CR><CR>",
    { noremap = true, desc = "Accept the first spelling suggestion" })
-- Add current word to dictionary
vim.api.nvim_set_keymap("n", "<leader>sa", "zg", { noremap = true, desc = "[S]pell [A]dd word to dictionary" })
